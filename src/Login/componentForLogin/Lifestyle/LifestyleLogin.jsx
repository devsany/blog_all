...
const LifestyleLogin = () => {
  ...
  const update = (e) => {
    ...
    if (topic === "") {
      ...
      axios.post("https://66990d882069c438cd712276.mockapi.io/Lifestyle", {
        topic: topic,
        realtion: relation,
        ...
        <div className=" row">
          ...
          <div className="relation col-md-6 pt-[39px] pb-[40px]">
            ...
            <ul>
              ...
              <li>Living Authentically</li>
              <li>Dev Diaries</li>
              <li>Chasing Simplicity</li>
                ...
                return (
                  <>
                    <tr key={i} className="border cursor-pointer border-black hover:bg-gray-200">
                      ...
                      <td className="border   cursor-pointer border-black hover:bg-gray-400">{elem.description}</td>
                      <td>
                        <button
